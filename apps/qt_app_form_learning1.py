...
class Window(QDialog):
    ...
    def __init__(self):
        ...
        self.return_dict['degree'] = ''
        self.return_dict['age'] = ''
    ...
    def getInfo(self):
        ...
        self.return_dict['name'] = f'{self.nameLineEdit.text()}'
        self.return_dict['degree'] = f'{self.degreeComboBox.currentText()}'
        self.return_dict['age'] = f'{self.ageSpinBar.text()}'
